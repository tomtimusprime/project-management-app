...
const IssueDetails = ({ show, handleClose, issue, setProjectData, projectId }) => {
    const { issueName: name, Date: issueDate, description, priority, _id: issueId } = issue;
    ...
    return (
        <div>
            <Modal show={show} onHide={handleClose}>
                ...
                <Modal.Footer>
                    <Button onClick={completeIssue} variant='success'>Complete</Button>
